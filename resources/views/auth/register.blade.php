            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="satker_asal" class="col-md-4 col-form-label text-md-right">{{ ('Satker Asal') }}</label>

                            <div class="col-md-6">
                                <input id="satker_asal" type="text" class="form-control @error('satker_asal') is-invalid @enderror" name="satker_asal" value="{{ old('satker_asal') }}" required autocomplete="satker_asal" autofocus>
